...
> [ [Source] ](https://github.com/helmwave/docs/tree/0.20.x/docs/examples/apps-per-ns)
...
looks how to work [HELMWAVE_TAGS](https://helmwave.github.io/docs/0.20.x/yaml/#tags)
