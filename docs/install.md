...
```bash
docker pull diamon/helmwave:0.21.0
docker pull ghcr.io/helmwave/helmwave:0.21.0

docker run --entrypoint=ash -it --rm --name helmwave ghcr.io/helmwave/helmwave:0.21.0
# helmwave version
0.21.0
#
```
...
```bash
docker pull diamon/helmwave:0.21.0-scratch
docker pull ghcr.io/helmwave/helmwave:0.21.0-scratch
```
