...
```bash
docker pull diamon/helmwave:0.19.0
docker pull ghcr.io/helmwave/helmwave:0.19.0

docker run --entrypoint=ash -it --rm --name helmwave ghcr.io/helmwave/helmwave:0.19.0
# helmwave version
0.19.0
#
```
...
```bash
docker pull diamon/helmwave:0.19.0-scratch
docker pull ghcr.io/helmwave/helmwave:0.19.0-scratch
```
