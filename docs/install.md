...
```bash
docker pull diamon/helmwave:0.17.2
docker pull ghcr.io/helmwave/helmwave:0.17.2

docker run --entrypoint=ash -it --rm --name helmwave ghcr.io/helmwave/helmwave:0.17.2
# helmwave version
0.17.2
#
```
...
docker run ghcr.io/helmwave/helmwave:0.17.2-scratch version
0.17.2
```
...
```bash
docker pull diamon/helmwave:0.17.2-scratch
docker pull ghcr.io/helmwave/helmwave:0.17.2-scratch
```
